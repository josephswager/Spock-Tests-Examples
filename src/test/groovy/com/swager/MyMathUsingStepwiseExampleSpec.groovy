...
class MyMathUsingStepwiseExampleSpec extends Specification {
    ...
    def "Step 1: "() {
        ...
        when: "give the denominator a value of 5.5"
            den = 5.5

        then: "then den will be greater than zero and equal 5.5"
            den > 0
            den == 5.5
    }

    def "Step 2: double denominator then the den value will be 11 also we can see the old method shows dens value is 5.5 before me made any changes"() {
        when:
